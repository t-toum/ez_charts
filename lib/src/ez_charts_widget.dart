import 'dart:async';
import 'package:ez_charts/src/chart_style.dart';
...
import 'package:ez_charts/src/extensions/map_ext.dart';
import 'package:ez_charts/src/renderer/chart_painter.dart';
import 'package:ez_charts/src/renderer/main_renderer.dart';
...
class EzChartsWidget extends StatefulWidget {
  final List<EzLineEntity>? datas;
  ...
  @override
  State<StatefulWidget> createState() => _EzChartsWidgetState();
}

class _EzChartsWidgetState extends State<EzChartsWidget>
  ...
  Widget _buildInfoDialog() {
    return StreamBuilder<InfoWindowEntity?>(
      ...
      builder: (context, snapshot) {
        ...
        EzLineEntity entity = snapshot.data!.kLineEntity;
