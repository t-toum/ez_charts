...
import 'package:ez_charts/src/painter_params.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';

import 'src/candle_data.dart';
import 'src/candle_style.dart';
import 'src/chart_painter.dart';
import 'package:intl/intl.dart' as intl;

class EzChart extends StatefulWidget {
  ...
  @override
  State<EzChart> createState() => _EzChartState();
}

class _EzChartState extends State<EzChart> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        final maxPrice = candlesInRange
            .map(highest)
            .whereType<double>()
            .reduce(max);
        final minPrice = candlesInRange
            .map(lowest)
            .whereType<double>()
            .reduce(min);
