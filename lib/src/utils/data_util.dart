...
class DataUtil {
  static calculate(List<EzLineEntity> dataList,
  ...
  static calcMA(List<EzLineEntity> dataList, List<int> maDayList) {
    List<double> ma = List<double>.filled(maDayList.length, 0);

    if (dataList.isNotEmpty) {
      for (int i = 0; i < dataList.length; i++) {
        EzLineEntity entity = dataList[i];
  ...
  static void calcBOLL(List<EzLineEntity> dataList, int n, int k) {
  ...
  static void _calcBOLLMA(int day, List<EzLineEntity> dataList) {
    double ma = 0;
    for (int i = 0; i < dataList.length; i++) {
      EzLineEntity entity = dataList[i];
      ma += entity.close;
  ...
  static void calcMACD(List<EzLineEntity> dataList) {
    double ema12 = 0;
    double ema26 = 0;
    double dif = 0;
    double dea = 0;
  ...
  static void calcVolumeMA(List<EzLineEntity> dataList) {
    double volumeMa5 = 0;
    double volumeMa10 = 0;

    for (int i = 0; i < dataList.length; i++) {
      EzLineEntity entry = dataList[i];
  ...
  static void calcRSI(List<EzLineEntity> dataList) {
    double? rsi;
    double rsiABSEma = 0;
    double rsiMaxEma = 0;
    for (int i = 0; i < dataList.length; i++) {
  ...
  static void calcKDJ(List<EzLineEntity> dataList) {
    var preK = 50.0;
    var preD = 50.0;
  ...
  static void calcWR(List<EzLineEntity> dataList) {
    double r;
    for (int i = 0; i < dataList.length; i++) {
      EzLineEntity entity = dataList[i];
      int startIndex = i - 14;
  ...
  static void calcCCI(List<EzLineEntity> dataList) {
